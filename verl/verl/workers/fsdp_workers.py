...
class ActorRolloutRefWorker(Worker, DistProfilerExtension):
    ...
    def _build_model_optimizer(
        ...
        try:
            ...
            if "molmo2" in local_path.lower():
                from sage.src.models.molmo2.config import Molmo2Config
                # override model kwargs
                actor_model_config = Molmo2Config.from_pretrained(
                    local_path, trust_remote_code=trust_remote_code, attn_implementation="flash_attention_2"
                )
            else:
                raise ValueError(f"Model config for {local_path} not found")
        ...
        with init_context(), warnings.catch_warnings():
            ...
            if "molmo2" in local_path:
                from sage.src.models.molmo2.modeling import Molmo2ForConditionalGeneration
                actor_module_class = Molmo2ForConditionalGeneration
