...
def _get_input_embeds(
    ...
    if pixel_values is None and pixel_values_videos is None:
        ...
        if model.visual.pos_embed.weight.device != inputs_embeds.device:
            model.visual.pos_embed.weight = torch.nn.Parameter(model.visual.pos_embed.weight.to(inputs_embeds.device))
