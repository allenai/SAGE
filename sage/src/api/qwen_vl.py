...
class QwenVL(BaseAPI):
    ...
    def get_response(
        ...
        **kwargs,
        ...
        inputs, multimodal_inputs = self._prepare_input(prompt, media, media_type, system_prompt)
...
if __name__ == "__main__":
    from sage.data.utils import CONTEXT_VLM_PROMPT, ITERATIVE_REASONER_PROMPT, ITERATIVE_REASONER_MSG_PROMPT
    qwen_vl = QwenVL(
        model_name="/root/home/checkpoints/sage/qwen25vl-3b-sft-06272025",
    )
