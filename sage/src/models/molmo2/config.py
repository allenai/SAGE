...
class Molmo2VitConfig(PretrainedConfig):
    ...
    model_type = "molmo2_vision_transformer"
...
class Molmo2Config(PretrainedConfig):
    ...
    >>> configuration = Molmo2Config(vit_config, adapter_config, text_config, image_patch_id=152069)
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.bi_directional_attn = bi_directional_attn
        self.initializer_range = initializer_range
