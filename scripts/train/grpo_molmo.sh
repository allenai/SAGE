...
export NUM_GPUS=8
export RUN_NAME=SAGE-MM-Molmo2-D-8B-SFT_RL
export DATASET=SAGE-MM-RL-7k/data
export SFT_CKPT=allenai/SAGE-MM-Molmo2-D-8B-SFT
export REWARD_FNS="json-format-args_re-args-curr_web_verb_p_acc-rt"

export IS_MOLMO2="True"
...
python \
    ...
    data.train_files=data/${DATASET}/train_molmo-00000-of-00001.parquet \
    data.val_files=data/${DATASET}/train_molmo-00000-of-00001.parquet \
    ...
    +actor_rollout_ref.agent.max_prompt_length=14336 \
    +actor_rollout_ref.agent.max_response_length=2048 \
    +actor_rollout_ref.agent.max_start_length=14336 \
    +actor_rollout_ref.agent.max_obs_length=14336 \
