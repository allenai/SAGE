...
if IS_MOLMO2:
    from sage.src.models.molmo2.vision_process import fetch_image, fetch_video
else:
    from sage.src.models.qwen_vl.vision_process import fetch_image, fetch_video
...
def process_video(
    ...
    return fetch_video(video, use_cache=use_cache)
